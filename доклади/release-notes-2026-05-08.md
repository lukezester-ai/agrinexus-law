...
- Добавена Cloudflare Turnstile защита за `vhod` и `waitlist` (client widget + server verify).
...
- Добави Turnstile ключовете във Vercel Environment Variables.
