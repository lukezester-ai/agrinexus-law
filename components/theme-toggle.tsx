...
export function ThemeToggle() {
	...
	if (!mounted) {
		return (
			<div
				className="fixed bottom-4 right-4 z-[100] h-12 w-12 rounded-full border border-slate-500/30 bg-slate-200/60 shadow-md backdrop-blur-md dark:border-teal-500/20 dark:bg-slate-900/50"
				aria-hidden
			/>
		);
	}
	...
	return (
		<motion.button
			type="button"
			onClick={toggle}
			className="fixed bottom-4 right-4 z-[100] flex h-12 w-12 items-center justify-center rounded-full border border-teal-400/25 bg-white/75 text-slate-800 shadow-[0_8px_32px_-8px_rgba(13,148,136,0.35)] backdrop-blur-xl dark:border-teal-500/30 dark:bg-slate-950/75 dark:text-teal-200 dark:shadow-[0_8px_36px_-6px_rgba(45,212,191,0.25)]"
