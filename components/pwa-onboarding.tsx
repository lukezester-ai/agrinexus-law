  ...
  const content = useMemo(() => {
    ...
    if (pathname.startsWith("/vhod")) {
      return {
        ...
        text: "Вход с magic link: без парола, само за вече активирани акаунти. AgriNexus не изпраща welcome или маркетинг — само системният имейл с връзка от Supabase, ако имейлът е одобрен.",
      };
    }
    return {
      title: "Добре дошъл в AgriNexus app",
      text: "Инсталираното приложение работи като самостоятелна app версия. За най-бърз достъп ползвай менюто: Документи, Срокове, Калкулатори и „Моя ферма“ (вход с имейл, без отделни съобщения от приложението).",
    };
  }, [pathname]);
