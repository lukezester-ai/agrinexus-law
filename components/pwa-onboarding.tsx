  ...
  const content = useMemo(() => {
    ...
    if (pathname.startsWith("/vhod")) {
      return {
        ...
        text: "Регистрация и вход са един процес (magic link): без парола. Въведи имейл, отвори връзката от пощата си — при първо потвърждение се създава акаунт.",
      };
    }
    return {
      title: "Добре дошъл в AgriNexus app",
      text: "Инсталираното приложение работи като самостоятелна app версия. За най-бърз достъп ползвай менюто: Документи, Срокове, Калкулатори и „Моя ферма“ (вход само с имейл).",
    };
  }, [pathname]);
