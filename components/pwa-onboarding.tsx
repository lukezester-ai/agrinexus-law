...
export function PwaOnboarding() {
  ...
  const content = useMemo(() => {
    ...
    if (pathname.startsWith("/vhod")) {
      return {
        title: "Помощ за „Моя ферма“",
        text: "Регистрация и вход с един magic link: без парола. При първи път потвърждаваш връзката от пощата — създава се акаунт и влизаш в „Моя ферма“; след това същият имейл е само вход. AgriNexus не изпраща welcome или маркетинг.",
      };
    }
    return {
      title: "Добре дошъл в AgriNexus app",
      text: "Инсталираното приложение работи като самостоятелна app версия. За най-бърз достъп ползвай менюто: Документи, Срокове, Калкулатори и „Моя ферма“ (регистрация и вход с имейл).",
    };
  }, [pathname]);
