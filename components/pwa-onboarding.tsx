...
export function PwaOnboarding() {
  ...
  const content = useMemo(() => {
    ...
    if (pathname.startsWith("/vhod")) {
      return {
        title: "Помощ за регистрация",
        text: "Регистрацията и входът са в един поток с magic link. Въведи имейл и потвърди от пощата си.",
      };
    }
    return {
      title: "Добре дошъл в AgriNexus app",
      text: "Инсталираното приложение работи като самостоятелна app версия. За най-бърз достъп ползвай менюто: Документи, Срокове, Калкулатори и Регистрация/Вход.",
    };
  }, [pathname]);
